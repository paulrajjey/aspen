...
<#if finalContractorChargeDate?has_content>
  <#assign myFccDate = mmddyy.format(finalContractorChargeDate)>
<#else>
  <#assign myFccDate = mmddyy.format(currentDT)>
</#if>
...
<div id="container">
	<div id="header">
		CMC Workflow: Phase 2 Work - Supervisor Approval Form
	</div>
	<div id="content">
              ...
              <tr align="left" valign="top">
                <td width="23%">                
                  <label for="supApprovalAction" 
                    class="longRequiredlabel">Sup Approval Action:</label>
                </td>
                <td width="27%"> 
